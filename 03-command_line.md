...
> > 'xargs' is a command that takes in Standard Input (which results from another function) and executes a command using each element of the Standard Input. An example follows:
find ./foo -type f -name "\*.txt" | xargs rm
This example shows how to find and delete all '.txt' extension files in the directory /foo.
